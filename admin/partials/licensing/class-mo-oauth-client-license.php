...
include_once dirname( __FILE__ ) .DIRECTORY_SEPARATOR.'class-mo-oauth-client-license-pricing-breakdown.php';


class MOOAuth_Client_Admin_Licensing {
...
<script>    
        ...
        var selectArray = JSON.parse('<?php echo json_encode(new MOOAuth_LicensePlansPricing()) ?>');
    ...
    jQuery('.support-form').submit(function(e){
        ...
        if(email == "" || query == "" || query1 == ""){
            ...
            json = {
                ...
                "company" : "<?php echo esc_attr( $_SERVER ['SERVER_NAME']);?>", 
                "firstName" : fname,
                "lastName" : lname,
            }
    ...
    function errorFunction(){
        ...
        <script>
            ...
            function upgradeform(planType) {
                if(planType === "") {
                    location.href = "../../../../miniorange-login-with-eve-online-google-facebook/";
                    return;
                } else {
