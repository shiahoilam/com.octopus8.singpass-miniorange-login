<?php
/**
 * setup wizard step 5 - show app summary 
 */
function mooauth_client_summary(){
  ...
  <div class="summary-form-container"><ui class="summary-wrapper">
    ...
    <label>Display name :</label>
      ...
      <a class="mo-editstep" data-step="3"></a>
  ...
  echo '<label>Client ID :</label>
      <input type="text"  style="border:none;"  class="mo-summary-id mo-summary-data" id="client_id_summary"
//       readonly="true"
       ></input>
      <a  class="mo-editstep" data-step="4"></a>
      </li><li class="summary-form-row">';
  ...
  echo '<label> SSO Test :</label>
      <div class="mo-summary-callback mo-summary-data"><input type="checkbox" name="debug" id="debug" checked>Enable Test Debugging History</div><a></a>
    </li>';
  echo '<div class="summary-form-container"></div><li class="summary-form-row">';
  echo '<label> Send client credentials in :</label>
      <div class="mo-summary-callback mo-summary-data mo-summary-flex-shrink" ><input type="checkbox" name="mo_oauth_authorization_header" id="send_header">Header</div><div class="mo-summary-callback mo-summary-data mo-summary-flex-grow"><input type="checkbox" name="mo_oauth_body" id="send_body" >Body</div>
